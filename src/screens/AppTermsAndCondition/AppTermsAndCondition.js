...
export default function AppTermsAndCondition({ navigation }) {
  ...
  return (
    ...
    Interpretation"
        ...
        />
        <View style={styles.gap} />
        <FlatText text="Delivery" font="q_regular" color="#333333" size={16} />
        <View style={styles.gap} />
        <FlatText
        ...
        />
        <View style={styles.gap} />
        <FlatText text="Waiver" font="q_regular" color="#333333" size={16} />
        <View style={styles.gap} />
        <FlatText
        ...
        <View>
          <TouchableOpacity
            ...
            style={styles.btn}
          >
            <FlatText text={t("agree")} font="q_regular" color="white" size={16} />
          </TouchableOpacity>
        </View>
        <View style={styles.gap} />
        <View style={styles.gap} />
